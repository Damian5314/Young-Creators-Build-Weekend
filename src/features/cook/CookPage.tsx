...
export default function CookPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const response = await recipesApi.generate(inputValue.trim(), token || undefined);
      ...
      <div className="page-container">
        ...
        <div className="max-w-lg mx-auto mb-8">
          <label className="block mb-3 text-sm font-medium text-muted-foreground ml-1">
            {mode === 'ingredients' ? 'What ingredients do you have?' : 'What would you like to eat?'}
          </label>
          ...
          >
            {loading ? (
              ...
              <>
                ...
                {mode === 'ingredients' ? 'Generate Recipes' : 'Get Ingredients List'}
              </>
            )}
          </Button>
        </div>
